package com.liumapp.api.connector;
...
public class UDPSocketMonitor extends Thread {
    ...
    public UDPSocketMonitor(String host, int port) {
        ...
        try {
            ...
            System.err.println("Startup fail, " + port + " port is taken or has no privilege. Check if you are running in root, or another DNS server is running.");
            log.error("Startup fail, " + port + " port is taken or has no privilege", e);
            System.exit(-1);
        }
